...
- Edit \BepInEx\config\BepInEx.cfg and change `[Chainloader] HideManagerGameObject` to `true` or set `[Preloader.Entrypoint] Type` to `MonoBehaviour`. Either option should work.
